...
export function addCategory(data, token) {
  return request("/api/create_category_intent/", {
    data,
    token,
    method: "POST",
  });
...
export function addMenuItems(data, token) {
  return request("/api/create_menu_items_intent/", {
    data,
    token,
    method: "POST",
  });
...
export function reorderCategories(placeId, orderedCategoryIds, token) {
  ...
  return request(`/api/places/${placeId}/categories/reorder/`, {
    data,
    token,
    method: "POST",
  });
...
export function reorderMenuItems(categoryId, orderedItemIds, token) {
  ...
  return request(`/api/categories/${categoryId}/menu-items/reorder/`, {
    data,
    token,
    method: "POST",
  });
