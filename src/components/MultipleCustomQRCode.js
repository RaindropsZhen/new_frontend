...
const MultipleCustomQRCode = ({ place, table,dotColor, cornersDotColor, cornersSquareColor, backgroundColorleft, backgroundColorright }) => {
...
export default MultipleCustomQRCode;
