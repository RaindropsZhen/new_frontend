...
const ModifyQRCode = ({
  ...
  const [NewcornersSquareColor, setNewcornersSquareColor] =
    useState(cornersSquareColor);
  const [NewbackgroundColorleft, setNewbackgroundColorleft] =
    useState(backgroundColorleft);
  const [NewbackgroundColorright, setNewbackgroundColorright] =
    useState(backgroundColorright);
    ...
    <div>
      ...
      >
        ...
        <Modal.Body>
          <Row>
            ...
            <Col md={6}>
              ...
              <ColorPickerComponent
                color={NewdotsColor}
                onChange={setNewdotsColor}
              />
              <h4>更改边缘方块颜色</h4>
              <ColorPickerComponent
                color={NewcornersDotColor}
                onChange={setNewCornersDotColor}
              />
              <h4>更改边缘方块外围颜色</h4>
              <ColorPickerComponent
                color={NewcornersSquareColor}
                onChange={setNewcornersSquareColor}
              />
              <h4>更改左上角渐变色</h4>
              <ColorPickerComponent
                color={NewbackgroundColorleft}
                onChange={setNewbackgroundColorleft}
              />
              <h4>更改右下角渐变色</h4>
              <ColorPickerComponent
                color={NewbackgroundColorright}
                onChange={setNewbackgroundColorright}
              />
              {/* Image Selector */}
              <div>
                <h4>选择图片</h4>
          ...
          <Row className="ml-5">
            <b>点击确认之后需要刷新页面才能显示最新二维码！</b>
          </Row>
        </Modal.Body>
        <Modal.Footer className="justify-content-center">
          <Row>
            <Button
              className="mr-4 btn-lg"
              variant="standard"
