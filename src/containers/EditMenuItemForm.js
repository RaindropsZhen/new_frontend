...
const EditMenuItemForm = ({ place, onDone, item = {} }) => {
  ...
  const {
    // category, // Removed as per ESLint no-unused-vars
    // setCategory, // Removed as per ESLint no-unused-vars
    itemName,
    setItemName,
    name_to_print,
    set_name_to_print,
  ...
  return (
    <div>
      ...
      <div>
        ...
        >
          {t("editMenuItemForm.title.changeName")}
        </p>
        <div style={{ marginLeft: "20px" }}>
          ...
          <Form.Group>
            ...
            <Form.Control
              ...
              onChange={(e) =>
                setItemName((prev) => ({ ...prev, default: e.target.value }))
              }
              required
            />
          </Form.Group>
          <Form.Group>
            ...
            <Form.Control
              ...
              value={itemName.en}
              onChange={(e) =>
                setItemName((prev) => ({ ...prev, en: e.target.value }))
              }
            />
          </Form.Group>
          ...
          <Form.Group>
            <Form.Label>
              {t("editMenuItemForm.label.portugueseName")}
            </Form.Label>
            <Form.Control
              type="text"
              placeholder={t(
              ...
              value={itemName.pt}
              onChange={(e) =>
                setItemName((prev) => ({ ...prev, pt: e.target.value }))
              }
            />
          </Form.Group>
      ...
      <div>
        ...
        >
          {t("editMenuItemForm.title.changePriceAndDescription")}
        </p>
        <div style={{ marginLeft: "20px" }}>
          <Form.Group>
          ...
          <Form.Group>
            <Form.Label>
              {t("editMenuItemForm.label.chineseDescription")}
            </Form.Label>
            <Form.Control
              type="text"
              placeholder={t(
                "editMenuItemForm.placeholder.enterChineseDescription",
              )}
          ...
          <Form.Group>
            <Form.Label>
              {t("editMenuItemForm.label.englishDescription")}
            </Form.Label>
            <Form.Control
              type="text"
              placeholder={t(
                "editMenuItemForm.placeholder.enterEnglishDescription",
              )}
              value={itemDescription.en}
              onChange={(e) =>
                setItemDescription((prev) => ({ ...prev, en: e.target.value }))
              }
            />
          </Form.Group>
          ...
          <Form.Group>
            <Form.Label>
              {t("editMenuItemForm.label.portugueseDescription")}
            </Form.Label>
            <Form.Control
              type="text"
              placeholder={t(
                "editMenuItemForm.placeholder.enterPortugueseDescription",
              )}
              value={itemDescription.pt}
              onChange={(e) =>
                setItemDescription((prev) => ({ ...prev, pt: e.target.value }))
              }
            />
          </Form.Group>
        </div>
      ...
      <div>
        ...
        >
          {t("editMenuItemForm.title.changeOrderingTiming")}
        </p>
        <Form.Group>
          <Form.Check
            type="checkbox"
        ...
        <p style={{ color: "gray", fontSize: "14px" }}>
          {t("editMenuItemForm.label.selectOrderingTiming")}
        </p>
        <Form.Group>
          <Form.Check
            type="checkbox"
      ...
      <div>
        ...
        >
          {t("editMenuItemForm.title.changeImage")}
        </p>
        <Form.Group>
          ...
          <ImageDropzone
            value={image}
            onChange={setImage}
            reset={resetImageDropzone}
            setReset={setResetImageDropzone}
          />
        </Form.Group>
      </div>

      <Button variant="standard" block onClick={onUpdateMenuItem}>
